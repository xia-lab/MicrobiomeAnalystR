...
mbSet<-FeatureCorrelation(mbSet, dist.name="pearson", taxrank="Genus", taxa="g__Bacteroides", variable="Class", datatype="16S", shotfeat="null", shotgunid="NA")
...
mbSet<-PerformUnivarTest(mbSet, variable="Class", p.lvl=0.05, datatype="16S", shotgunid="NA", taxrank="Genus",
                         statOpt="nonpar")
...
```{r, eval=FALSE}
# edgeR at the genus level
mbSet<-PerformRNAseqDE(mbSet, opts="EdgeR", p.lvl=0.05, variable="Class", datatype="16S", shotgunid="NA", taxrank="Genus");

# DESeq2 at the genus level
mbSet<-PerformRNAseqDE(mbSet, opts="DESeq2", p.lvl=0.05, variable="Class", datatype="16S", shotgunid="NA", taxrank="Genus");
```
...
mbSet<-PerformMetagenomeSeqAnal(mbSet, variable="Class", p.lvl=0.05, datatype="16S", shotgunid="NA",
                                taxrank="Genus", model="zigfit");
```
...
mbSet<-PerformLefseAnal(mbSet, p.lvl=0.05, lda.lvl=2.0, variable="Class", isfunc="F", datatype="16S",
                        datatype="NA", taxrank="Genus");

# Plot LefSe results
mbSet<-PlotLEfSeSummary(mbSet, ldaFeature=15, imgName="bar_graph_1", format="png")
```
...
mbSet<-RF.Anal(mbSet, treeNum=500, tryNum=7, randomOn=1, variable="Class", taxrank="OTU", datatype="16S")

# Plot the RF classification results
mbSet<-PlotRF.Classify(mbSet, feature=15, imgName="rf_cls_0", format="png", width=NA)

# Plot the RF Variable Importance Plot
mbSet<-PlotRF.VIP(mbSet, feature=15, imgName="rf_imp_0", format="png", width=NA)
```
