...
PlotTreeGraph<-function(plotNm,distnm,clstDist,metadata,datatype,taxrank,format="png", dpi=72, width=NA){
    set.seed(2805619);
...
###########Heatmap#############
#######################################
PlotHeatmap<-function(plotNm, smplDist, clstDist, palette,metadata,taxrank,datatype,viewOpt,doclust,format="png",showfeatname,appendnm,rowV=F,colV=T,var.inx=NA,border=T,width=NA,dpi=72){
    set.seed(2805614);
